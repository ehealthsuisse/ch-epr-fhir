...
A Document Source shall be able to send a request for either the JSON or the XML format as defined in FHIR. A Document Recipient shall be able to support the JSON and the XML format.
...
The **Document Source** shall be able to record an
...
The **Document Recipient** shall be able to record an
