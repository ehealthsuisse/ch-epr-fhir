...
[ITI-130]](https://profiles.ihe.net/ITI/mCSD/ITI-130.html) transaction defined in the mCSD profile published in the
...
[CH mCSD Practitioner](StructureDefinition-CH.mCSD.Feed.Practitioner.html),
...
The **Data Source** and **Directory** SHALL record an audit event for the operations according to:
