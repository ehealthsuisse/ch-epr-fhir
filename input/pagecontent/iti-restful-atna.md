This section specifies Swiss national extensions to the Add RESTful ATNA (Query and Feed) supple-ment, which is published as an IHE ITI Trial Implementation profile.
