...
* IUA and MHD: Image Sources as technical user: there are currently no radiology integration projects in the EPR, so no specification on how to connect Imaging Document Sources as technical users is needed at this time. Deferred until radiology archives are connected to the EPR, otherwise foreseen for the future E-GD [#177](https://github.com/ehealthsuisse/ch-epr-fhir/issues/177)
