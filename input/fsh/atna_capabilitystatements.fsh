...
* rest
  ...
  * resource[+]
    ...
    * supportedProfile[+] = "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ch-mhd-updatedocumentmetadata-audit-recipient"
    ...
    * supportedProfile[+] = "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventmCSD1Create"
    * supportedProfile[+] = "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventmCSD1Update"
    * supportedProfile[+] = "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/ChAuditEventmCSD1Delete"
